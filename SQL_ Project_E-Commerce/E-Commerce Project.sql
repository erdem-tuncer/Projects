...
--the total number of unique customers in January
...
--Basic formula: o	Month-Wise Retention Rate = 1.0 * Number of Customers Retained in The Next Month / Total Number of Customers in The Previous Month
